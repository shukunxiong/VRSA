# refer from zhaoshiji 123's project: https://github.com/zhaoshiji123/SI-Attack


def extract_content(text, tag="#thescore:"):
    ...
    # Iterate over each line to find the line containing the tag
    for line in lines:
        if tag in line:
    ...
    # If no number is found after the tag, return None
    return 1
...
judge_template = """
    ...
    #thescore: your score here, Please output in one line, do not line break!
